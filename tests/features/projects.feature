Feature: Project Management
  ...
  Scenario Outline: Add new project with various inputs
    ...
    Examples:
      ...
      | Project A    | Pham Trung Kien   | 100   | Highest  | 01-07-2025        | 15      | This is a detailed summary over 60 characters for success case.         | Team Alpha | success | Project added.                              |
      |              | Pham Trung Kien   | 80    | Normal   | 01-07-2025        | 15      | Summary here is valid too.                                              | Team Beta  | error   | The title field is required.                |
